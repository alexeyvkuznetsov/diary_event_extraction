...
2.  **Код и данные:** Автоматическое извлечение информации из эго-документа: сравнительный анализ эффективности больших языковых моделей на примере дневника К.А. Березкина. URL: https://github.com/alexeyvkuznetsov/diary_event_extraction
